const SCENARIOS = [
  {
    ...
    hazards: [
      ...
      { id: 'hz-2', type: 'collapse', label: 'Artçı: 1. Rotayı Kesti (Kuzey Otoyolu)', center: [36.2131, 36.1829], radiusKm: 0.9, severity: 0.65, delaySec: 10 },
      { id: 'hz-3', type: 'collapse', label: 'Artçı: 2. Rotayı Kesti (Serinyol)', center: [36.2040, 36.1563], radiusKm: 0.8, severity: 0.58, delaySec: 25 },
      { id: 'hz-4', type: 'collapse', label: 'Artçı: Hedefi Kuzeybatıdan Çevirdi', center: [36.2120, 36.1680], radiusKm: 0.8, severity: 0.72, delaySec: 40 },
      { id: 'hz-5', type: 'collapse', label: 'Artçı: Hedefi Güneyden Çevirdi', center: [36.1990, 36.1770], radiusKm: 0.8, severity: 0.62, delaySec: 55 },
    ],
    safeCorridors: [
