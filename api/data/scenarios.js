const SCENARIOS = [
  {
    ...
    hazards: [
      ...
      { id: 'hz-2', type: 'collapse', label: 'Artçı: Defne Fay Çöküntüsü', center: [36.1859, 36.1499], radiusKm: 0.8, severity: 0.65, delaySec: 10 },
      { id: 'hz-3', type: 'collapse', label: 'Artçı: Serinyol Ağır Hasar', center: [36.2068, 36.1728], radiusKm: 0.5, severity: 0.58, delaySec: 25 },
      { id: 'hz-4', type: 'collapse', label: 'Artçı: Kuzey Otoyolu Yıkımı', center: [36.2137, 36.1814], radiusKm: 0.6, severity: 0.72, delaySec: 40 },
      { id: 'hz-5', type: 'collapse', label: 'Artçı: Asi Nehri Çevresi Çökme', center: [36.1989, 36.1626], radiusKm: 0.7, severity: 0.62, delaySec: 55 },
    ],
    safeCorridors: [
